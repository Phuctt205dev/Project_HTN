...
// const char* mqtt_server = "172.20.10.2";  // Địa chỉ MQTT broker
...
// int greenDuration1 = 10;
// int greenDuration2 = 10;
// const int yellowDuration = 3;

// // Flags chỉ cập nhật thời gian khi chuyển pha
...
//     vehicles_road1 = count;
//   } else if (String(topic) == "vehicles/road2") {
//     vehicles_road2 = count;
//   }
// }
...
//     case GREEN1:
//       if (!timingUpdated) {
//         greenDuration1 = (vehicles_road1 > 4) ? 20 : 10;
//         setLights(LOW, LOW, HIGH, HIGH, LOW, LOW);
//         timingUpdated = true;
//         stateStart = currentMillis;
//       }
//       if (currentMillis - stateStart >= greenDuration1 * 1000) {
...
//         stateStart = currentMillis;
//       }
//       if (currentMillis - stateStart >= yellowDuration * 1000) {
//         currentState = GREEN2;
//         timingUpdated = false;
//       }
//       break;
...
//     case GREEN2:
//       if (!timingUpdated) {
//         greenDuration2 = (vehicles_road2 > 4) ? 20 : 10;
//         setLights(HIGH, LOW, LOW, LOW, LOW, HIGH);
//         timingUpdated = true;
//         stateStart = currentMillis;
//       }
//       if (currentMillis - stateStart >= greenDuration2 * 1000) {
